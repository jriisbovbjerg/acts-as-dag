...
* O(x*y) insert, update and delete, where x & y are the number of ancestors and descendants of a node.
 ...
 --- Added option to have more than one link between same two nodes... ( actualy I just have removed the validity check,  I have no idea if it's going to work... /jriisbovbjerg
== Requirements
